      ...
      <div className='petsitter-info-post'>
        <div className='petsitter-left-side'>
          ...
          <div className='petsitter-user-info'>
            ...
            <div className='petsitter-text-info'>
              ...
              <div className='petsitter-nicknames-and-address'>
                <span className='petsitter-nickname'> {petSitterInfo.nickname}</span>
                <span className='petsitter-address'> {petSitterInfo.address}</span>
              </div>
              <div className='petsitter-order-date-and-view'>
                <span className='petsitter-order-by-date'> 작성일: {petSitterInfo.createAt}</span>
                <span className='view-count'> 조회: {petSitterInfo.viewCnt}</span>
              </div>
            </div>
          </div>
          ...
          <span className='petsitter-extra-pics'>
            <img src={petSitterInfo.profilePic2} alt='petsitter profile pic2'></img>
            <img src={petSitterInfo.profilePic3} alt='petsitter profile pic3'></img>
            <img
              src={petSitterInfo.profilePic4 ? petSitterInfo.profilePic4 : '/imgs/Logo-Icon.png'}
              alt='petsitter profile pic4'
            ></img>
            <img
              src={petSitterInfo.profilePic5 ? petSitterInfo.profilePic5 : '/imgs/Logo-Icon.png'}
          ...
          <div className='self-introduction'>
            ...
            <p>
              ...
              {/* {petSitterInfo.contents} */}
            </p>
          </div>

          <div className='petsitter-location'>펫시터위치</div>
          <div className='kakao-map'>
            {petSitterInfo.latitude && petSitterInfo.longitude && (
              <Map
                center={{
                  lat: petSitterInfo.latitude,
                  lng: petSitterInfo.longitude,
                }}
          ...
          <div className='petsitter-review'>
            <span>리뷰 ( {petSitterInfo.reviewCnt}개 )</span>
            <span>{petSitterInfo.rating}</span>
          </div>

          {/* {
            // 리뷰 개수만큼 컴포넌트 생성
            Array.from({ length: petSitterInfo.reviewCnt }).map((_, index) => (
              <PetSitterInfoReview key={index} />
            ))
          } */}
        ...
        <div className='petsitter-right-side'>
          <div className='price-table'>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>{petSitterInfo.standardPrice}</td>
                  <td>{petSitterInfo.addPrice}</td>
                  <td>{petSitterInfo.nightPrice}</td>
                </tr>
              </tbody>
            </table>
          </div>
